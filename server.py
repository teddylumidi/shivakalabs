...
def generate_cover_letter_docx(filename):
    """Generate a professional cover letter in Word format"""
    doc = Document()
    ...
    doc.add_paragraph(
        'I am writing to express my interest in the position. With my professional '
        'experience and skills, I am confident in my ability to contribute significantly '
        'to your organization.'
    )
    doc.add_paragraph()
    
    doc.add_paragraph(
        'Throughout my career, I have developed strong expertise in various areas and '
        'have consistently delivered excellent results. I am excited about the opportunity '
